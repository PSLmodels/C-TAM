'''                                 
About: 
    This script imputes Unemployment Insurance (UI) compensation for regular and worshare programs using logistic regression. 
...
CPS_dataset.to_csv('UI_imputation_logreg.csv', 
