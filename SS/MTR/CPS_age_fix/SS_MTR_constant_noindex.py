...
def get_LE(YrsPstHS, Reg_YrsPstHS, age, adjustment, bendpoints, max_earnings, earning,\
		in1, in2, in3, in4, in5, in6, in7, in8, in9, in10, in12, in13, race_1, race_4,race_5 ,race_6 ,race_8,race_14, \
		race_21 ,race_22, a_sex, age_child, child):
	'''
	Creates the Lifetime Earnings vector with and without adjustment
...
final[['SS_MTR_head', 'SS_MTR_spouse', 'earned_income_head' , 'earned_income_spouse', 'CPSSEQ', 'AIME_head', 'AIME_spouse']].to_csv('SS_MTR_ConstantFuture_RETS_age_fixed_noindex.csv', index = None)
