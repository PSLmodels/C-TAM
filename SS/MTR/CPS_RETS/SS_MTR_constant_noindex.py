...
final[['SS_MTR_head', 'SS_MTR_spouse', 'earned_income_head' , 'earned_income_spouse', 'CPSSEQ', 'AIME_head', 'AIME_spouse']].to_csv('SS_MTR_ConstantFuture_RETS_noindex.csv', index = None)
