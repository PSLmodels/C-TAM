...
model = sm.Logit(endog = CPS_dataset.indicator, exog = CPS_dataset[['intercept',
 'Armed Forces','Construction', 'Educational and health services' ,'Financial activities',
 'Information' ,'Leisure and hospitality', 'Manufacturing' ,'Mining',
 'Other services' ,'Professional and business services',
